<section class="breadcrumb-section set-bg" data-setbg="<?echo BASE_URL?>/public/img/breadcrumb.jpg">
        <div class="container">
            <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <div class="blog__item">
                                ...
                                <div class="blog__item__text">
                                    ...
                                    <h5><a href="<?php echo BASE_URL?>/tintuc/chitiettin/14"><?php echo $post['title_post_text']?></a></h5>
